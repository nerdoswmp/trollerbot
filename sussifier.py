...
# Code made entirely by LinesGuy on github (https://github.com/LinesGuy/img_sussifier/blob/main/sus.py), with some adjustments to the gif conversion part
...
try:
  def sussy(name):
    ...
    images[0].save("out.gif", save_all=True, append_images=images[1:], loop=0, duration=45)
